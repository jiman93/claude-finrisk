...
- [X] Do you have a domain to add a subdomain to?
- [X] Confirm OpenAI model names in `.env` (explorer found `gpt-5.2` — is that correct?)
- [X] Do participants need accounts/passwords, or is participant ID the only gate?
